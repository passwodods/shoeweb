      ...
      <div className="container mx-auto max-w-4xl bg-white/90 backdrop-blur-sm p-6 md:p-10 rounded-lg shadow-xl border border-gray-200">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-10">
            ...
            <Link
              href="/"
              className={`px-6 py-3 rounded-lg text-white font-semibold transition duration-300 ${themeButtonClass} shadow-md hover:shadow-lg transform hover:scale-105`}
            >
              Continue Shopping
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 bg-gray-50 p-6 rounded-lg shadow-inner border h-fit sticky top-24">
              ...
              <Link
                href="/checkout"
                className={`block w-full text-center px-6 py-3 rounded-lg text-white font-bold transition duration-300 ${themeButtonClass} shadow-md hover:shadow-lg transform hover:scale-105`}
              >
                Proceed to Checkout
              </Link>
            </div>
